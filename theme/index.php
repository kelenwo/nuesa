 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li><br>
                              <h3 style="font-family: Montserrat;font-size: 38px;">Delivering Quality Education</h3>
                           <h1 style="font-size: 85px;">THE UNIQUE METHOD</h1>
                        ...
                        <li><br>
                            <h3 style="font-family: Montserrat;font-size: 38px;">Delivering Quality Education</h3>
                           <h1 style="font-size: 85px;">UNMATCHED APPROACH</h1>
                        ...
                        <li><br>
                            <h3 style="font-family: Montserrat;font-size: 38px;">Delivering Quality Education</h3>
                           <h1 style="font-size: 85px;">AWESOME FACULTY PANEL</h1>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" style="font-size: 35px;"><i class="fa fa-gear"></i>FACULTY OF ENGINEERING - UNIUYO <i class="fa fa-gear"></i> </h2>
                   </div>
               </div>
             </div>
    ...
    <!--HOME SECTION TAG LINE END-->
         <div id="features-sec" class="container set-pad" >
                 ...
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line" style="font-size: 30px;">WELCOME </h1>
                     <p style="font-size:17px; font-family: Montserrat;" data-scroll-reveal="enter from the bottom after 0.1s" >
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-  col-md- col-sm-" data-scroll-reveal="enter from the bottom after 0.4s">
                  ...
                  <div class="row" style="font-size:18px; font-family: Montserrat;">
   ...
   <div class="lnk1 img-bg p-tb30" style="">
               <div class="container">
                   <h5 class="h6-s inline" style="font-size:30px; font-family: Montserrat SemiBold;">PROVIDING THE WORLD WITH QUALITY ENGINEERS SINCE 1995</h5>
    ...
    <!-- FACULTY SECTION END-->
      <div id="course-sec" class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line" style="font-size: 30px;">GALLERY </h1>
             ...
             <div class="container">
               ...
               <div class="col-sm-12 col-md-12 col-lg-12">
                 ...
                 <div class="left-arrow"> <i class="fa fa-arrow-left" style="font-size: 40px;"></i> </div>
                 <div class="right-arrow"> <i class="fa fa-arrow-right" style="font-size: 40px;"></i> </div>
      ...
      <div id="course-sec" class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" style="font-size: 30px;" class="header-line">SPOTLIGHT </h1>
           ...
           <div class="container">
             ...
             <div class="col-lg-12  col-md-12 col-sm-12">
               <div class="col-md-4 col-sm-4 m-b15">
                <div class="spot">
                  <div class="overlay">
                  <img src="<?php echo base_url();?>theme/assets/img/dean.jpg">
                  <div class="cap">
                     <h5 class="h6-s" >Prof. Aniekan Offiong</h5>
                     <h5 class="white" style="font-family: Montserrat;">Dean of Faculty</h5>
                   </div>
                 </div>
                </div>
               </div>
               <div class="col-md-4 col-sm-4 m-b15">
                 <div class="spot">
                   <div class="overlay">
                   <img src="<?php echo base_url();?>theme/assets/img/ena.jpg">
                   <div class="cap">
                      <h5 class="h6-s">Ena John</h5>
                      <h5 class="white" style="font-family: Montserrat;">Faculty President</hs>
                    </div>
                 </div>
               </div>
               ...
               <div class="col-md-4 col-sm-4 m-b15">
                 <div class="spot">
                   <div class="overlay">
                   <img src="<?php echo base_url();?>theme/assets/img/vp.jpg">
                   <div class="cap">
                      <h5 class="h6-s">Iniobong Antai</h5>
                      <h5 class="white" style="font-family: Montserrat;">Vice President</h5>
                    </div>
                 </div>
               </div>
               </div>
           ...
           var images= [];
           images[0]= '<?php echo base_url();?>theme/assets/img/building.jpg';
