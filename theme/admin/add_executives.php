...
<div class="">
 ...
 <li class="active"><a class="" href="#tab1" data-toggle="tab">Add Executive</a></li>
  </ul>
...
<form id="sub">
  <div class="container-fluid">
   ...
   <label for="faculty_name">Executive Name</label>
   <div class="input-group">
     <span class="input-group-addon">
     <i class="fa fa-user"></i>
     </span>
   <input type="text" name="name" required=""   class="form-control" id="name" placeholder="Executive name">
 </div></div></div>
  <div class="col-md-6 col-xs-6">
   <div class="form-group">
   <label for="faculty_name">Type</label>
   <div class="input-group">
     <span class="input-group-addon">
     <i class="fa fa-user"></i>
     </span>
     <select class="form-control" name="type">
       <?php foreach ($get as $type ) {
