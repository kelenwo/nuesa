        ...
        <div class="">
          ...
          <div id="myTabContent" class="tab-content">
              ...
              <div class="form-group">
                <label for="name">Executive ID</label>
                <div class="input-group" title="Registration Number">
                <span class="input-group-addon">
                    <i class="fa fa-user"></i>
                </span>
                <input required type="text" name="id" class="form-control" placeholder="Executive ID">
              </div></div></div>
        <div class="col-md-4 col-xs-4">
        <div class="form-group">
<br/>
        <button style="margin-top:7px;" class="btn btn-primary" type="button" id="edit">Edit Executive
