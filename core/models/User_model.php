...
$query = $this->db->insert('executives', $data);
if($query) {
  return true;
} else {
  return false;
...
$query = $this->db->insert('session', $this->input->post());
if($query) {
  return true;
} else {
  return false;
...
$query = $this->db->update('executives', $data);
if($query) {
  return true;
} else {
  return false;
...
public function get_session() {
  $this->db->order_by('session_name','DESC');
